...
public class StateCollector  {
	...
	StateCollector(Connection conn, String tableprefix, String glosstable, Display display, StyledText charLog,
		IOrganStateKnowledgeBase organStateKnowledgeBase, IInflector inflector) {
		this.statematrix = new StateMatrix(conn, tableprefix, glosstable, organStateKnowledgeBase);
	...
	StateCollector(Connection conn, String tableprefix, ArrayList<String> knownstates, String glosstable, Display display, StyledText charLog,
		...
		if(knownstates!=null){
			...
			this.statematrix = new StateMatrix(conn, tableprefix, si.getStates(),glosstable, organStateKnowledgeBase);
		}
		this.tableprefix = tableprefix;
		this.conn = conn;
		this.glosstable = glosstable;
	...
	public void collect(){
		...
		SentenceOrganStateMarker sosm = new SentenceOrganStateMarker(this.conn, this.tableprefix, this.glosstable, true, display, charLog, inflector);//tag organ names
