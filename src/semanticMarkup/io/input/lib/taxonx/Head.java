 ...
 *         &lt;element name="title" type="{http://www.taxonx.org/schema/v1}title"/>
 *       &lt;/choice>
...
@XmlType(name = "head", namespace = "http://www.taxonx.org/schema/v1", propOrder = {
    "content"
})
public class Head {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "title", namespace = "http://www.taxonx.org/schema/v1", type = JAXBElement.class, required = false),
