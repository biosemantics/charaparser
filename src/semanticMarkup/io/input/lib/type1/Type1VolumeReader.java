...
public class Type1VolumeReader extends AbstractFileVolumeReader {
	...
	private Type1DocumentElementsExtractor documentElementsExtractor;
	private Type1TaxonExtractor taxonExtractor;
	...
	public Type1VolumeReader(@Named("Type1VolumeReader_Sourcefile") String filepath,
			...
			@Named("Type1VolumeReader_StyleNamePattern") String styleNamePattern,
			@Named("Type1VolumeReader_StyleKeyPattern") String styleKeyPattern,
			@Named("Type1VolumeReader_Tribegennamestyle") String tribegennamestyle, 
			...
			@Named("Type1VolumeReader_StyleMappingFile") String styleMappingFile, 
			DistributionTreatmentRefiner distributionTreatmentRefiner, 
			FloweringTimeTreatmentRefiner floweringTimeTreatmentRefiner) {
		super(filepath);
		this.documentElementsExtractor = new Type1DocumentElementsExtractor(
				filepath, styleStartPattern, styleNamePattern, styleKeyPattern,
				tribegennamestyle);
		this.taxonExtractor = new Type1TaxonExtractor();
