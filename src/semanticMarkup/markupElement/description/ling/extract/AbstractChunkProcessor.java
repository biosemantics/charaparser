...
public abstract class AbstractChunkProcessor implements IChunkProcessor {
	...
	protected List<Structure> establishSubject(
		...
		List<Structure> subjectStructures = createStructureElements(subjectChunks, processingContextState);
	...
	protected List<Structure> createStructureElements(List<Chunk> subjectChunks, ProcessingContextState processingContextState) {
		...
		if(!organChunks.isEmpty()) {
			for(Chunk organChunk : organChunks) {
				...
				int structureIdString = processingContextState.fetchAndIncrementStructureId(structure);
	...
	protected Relation addRelation(String relationName, List<Chunk> modifiers,
		...
		relation.setId("r" + String.valueOf(processingContextState.fetchAndIncrementRelationId(relation)));	
