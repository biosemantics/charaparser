...
my $lm = $ARGV[1];  #learning mode:"adj" or "plain"
...
my $user = $ARGV[5];
my $password = $ARGV[6];
my $prefix = $ARGV[7]; #prefix for all tables generated by this program
my $kb = $ARGV[8]; #glossary used as KnowledgeBase
