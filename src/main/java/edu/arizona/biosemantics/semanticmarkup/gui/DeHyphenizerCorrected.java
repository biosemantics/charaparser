...
public class DeHyphenizerCorrected extends DeHyphenizer {
	...
	public DeHyphenizerCorrected(String databaseName, String databaseUser, String databasePassword, 
			String table, String column, String countcolumn, String hyphen, String glossarytable) {
		super(databaseName, databaseUser, databasePassword, table, column, countcolumn, hyphen, glossarytable);
	}
