...
public class ElementRelationGroup {
	...
	public static String entityElements = "structure|substance|taxon_name"; //solid entity element
	...
	public static String possessPreps="with|without|devoid[_ -]of"; //prepositions indicates a possession relation
