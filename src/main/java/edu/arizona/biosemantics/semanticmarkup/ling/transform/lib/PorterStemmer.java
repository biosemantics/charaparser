...
import edu.arizona.biosemantics.semanticmarkup.ling.transform.IStemmer;
...
public class PorterStemmer implements IStemmer {
	...
	@Override
	public List<String> getStems(String word, edu.arizona.biosemantics.semanticmarkup.ling.pos.POS pos) {
		return this.getStems(word);
	}
}
