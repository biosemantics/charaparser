...
import edu.arizona.sirls.semanticMarkup.eval.IEvaluator;
import edu.arizona.sirls.semanticMarkup.io.InputStreamCreator;
import edu.arizona.sirls.semanticMarkup.know.IGlossary;
import edu.arizona.sirls.semanticMarkup.know.lib.CSVGlossary;
import edu.arizona.sirls.semanticMarkup.ling.normalize.INormalizer;
...
import edu.arizona.sirls.semanticMarkup.markupElement.description.eval.io.lib.MOXyDescriptionMarkupResultReader;
import edu.arizona.sirls.semanticMarkup.markupElement.description.eval.lib.PerfectPartialPrecisionRecallEvaluator;
...
import edu.arizona.sirls.semanticMarkup.markupElement.description.io.lib.EvaluationDBDescriptionReader;
import edu.arizona.sirls.semanticMarkup.markupElement.description.io.lib.MOXyBinderDescriptionWriter;
import edu.arizona.sirls.semanticMarkup.markupElement.description.io.lib.MOXyDescriptionWriter;
...
import edu.arizona.sirls.semanticMarkup.markupElement.description.run.DescriptionMarkupRun;
import edu.arizona.sirls.semanticMarkup.markupElement.description.transform.GUIDescriptionTransformer;
...
public class RunConfig extends BasicConfig {
	...
	public void configure() {
		...
		try {
			...
			bind(new TypeLiteral<List<InputStream>>() {}).annotatedWith(Names.named("DescriptionReader_BindingsFiles")).toInstance(createDescriptionReaderBindingsList());
	...
	private List<InputStream> createDescriptionReaderBindingsList() throws IOException {
		List<InputStream> result = new LinkedList<InputStream>();
