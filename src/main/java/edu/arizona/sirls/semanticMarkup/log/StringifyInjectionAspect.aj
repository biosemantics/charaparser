package edu.arizona.sirls.semanticMarkup.log;
...
public aspect StringifyInjectionAspect {
	...
	declare parents : edu.arizona.sirls.semanticMarkup.* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.config..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.eval..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.model..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.gui..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.io..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.know..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.ling..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.markup..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.markupElement..* implements IPrintable;
	declare parents : edu.arizona.sirls.semanticMarkup.run..* implements IPrintable;
