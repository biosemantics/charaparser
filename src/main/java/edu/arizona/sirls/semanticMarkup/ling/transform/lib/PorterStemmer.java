...
import edu.arizona.sirls.semanticMarkup.ling.transform.IStemmer;
...
public class PorterStemmer implements IStemmer {
	...
	@Override
	public List<String> getStems(String word, edu.arizona.sirls.semanticMarkup.ling.pos.POS pos) {
