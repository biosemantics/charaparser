package edu.arizona.sirls.semanticMarkup.markupElement.description.eval.lib;
...
import edu.arizona.sirls.semanticMarkup.eval.metric.PrecisionCalculator;
import edu.arizona.sirls.semanticMarkup.eval.metric.RecallCalculator;
import edu.arizona.sirls.semanticMarkup.eval.result.IEvaluationResult;
import edu.arizona.sirls.semanticMarkup.eval.result.PerfectPartialPrecisionRecallEvaluationResult;
import edu.arizona.sirls.semanticMarkup.eval.result.PrecisionRecallEvaluationResult;
import edu.arizona.sirls.semanticMarkup.eval.result.PrecisionRecallResult;
...
public class PerfectPartialPrecisionRecallEvaluator implements IDescriptionMarkupEvaluator {
	...
	private PrecisionRecallResult evaluatePartialRelation(List<Relation> testRelations, List<Relation> correctRelations) {
		...
		IMatcher<Relation> partialRelationMatcher = 
				new edu.arizona.sirls.semanticMarkup.markupElement.description.eval.matcher.partial.RelationMatcher();
	...
	private PrecisionRecallResult evaluatePerfectRelation(List<Relation> testRelations, List<Relation> correctRelations) {
		...
		IMatcher<Relation> perfectRelationMatcher = 
				new edu.arizona.sirls.semanticMarkup.markupElement.description.eval.matcher.perfect.RelationMatcher();
	...
	private PrecisionRecallResult evaluatePartialCharacter(List<Character> testCharacters, List<Character> correctCharacters) {
		...
		IMatcher<Character> partialCharacterMatcher = 
				new edu.arizona.sirls.semanticMarkup.markupElement.description.eval.matcher.partial.CharacterMatcher();		
	...
	private PrecisionRecallResult evaluatePerfectCharacter(List<Character> testCharacters, List<Character> correctCharacters) {
		...
		IMatcher<Character> perfectCharacterMatcher = 
				new edu.arizona.sirls.semanticMarkup.markupElement.description.eval.matcher.perfect.CharacterMatcher();		
	...
	private PrecisionRecallResult evaluatePartialStructure(List<Structure> testStructures, List<Structure> correctStructures) {
		...
		IMatcher<Structure> partialStructureMatcher = 
				new edu.arizona.sirls.semanticMarkup.markupElement.description.eval.matcher.partial.StructureMatcher();
	...
	private PrecisionRecallResult evaluatePerfectStructure(List<Structure> testStructures, List<Structure> correctStructures) {
		...
		IMatcher<Structure> perfectStructureMatcher =
				new edu.arizona.sirls.semanticMarkup.markupElement.description.eval.matcher.perfect.StructureMatcher();
