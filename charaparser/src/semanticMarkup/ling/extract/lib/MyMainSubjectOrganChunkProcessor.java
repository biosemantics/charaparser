...
public class MyMainSubjectOrganChunkProcessor extends AbstractChunkProcessor {

	@Inject
	public MyMainSubjectOrganChunkProcessor(IInflector inflector, IGlossary glossary, ITerminologyLearner terminologyLearner, 
