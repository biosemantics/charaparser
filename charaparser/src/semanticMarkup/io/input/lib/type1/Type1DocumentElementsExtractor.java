...
public class Type1DocumentElementsExtractor {
	...
	@Inject
	public Type1DocumentElementsExtractor(@Named("sourcefile") String filepath,
			@Named("styleStartPattern") String styleStartPattern,
			@Named("styleNamePattern") String styleNamePattern,
			@Named("styleKeyPattern") String styleKeyPattern,
			@Named("tribegennamestyle") String tribegennamestyle) {
	...
	public LinkedHashMap<Treatment, LinkedHashMap<String, ArrayList<DocumentElement>>> 
		...
		Document document = builder.build(this.filepath);
