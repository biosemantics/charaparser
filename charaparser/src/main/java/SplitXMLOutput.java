...
public class SplitXMLOutput {
	...
	public static void main(String[] args) throws Exception {
		...
		String comparisonFiles = "src/test/resources/evaluationData/FNAV19_AnsKey_CharaParser_Evaluation";
		//String comparisonFiles = "src/test/resources/evaluationData/TIP_AnsKey_CharaParser_Evaluation";
		String outDir = "src/test/resources/evaluationData/my";
