...
public class FNAv19Config extends RunConfig {
	...
	public void configure() {
		...
		bind(String.class).annotatedWith(Names.named("GuiceModuleFile")).toInstance("src//main//java//semanticMarkup//FNAv19Config.java");

		String evaluationDataPath = "src/test/resources/evaluationData/FNAV19_AnsKey_CharaParser_Evaluation";
		...
		bind(String.class).annotatedWith(Names.named("CSVGlossary_filePath")).toInstance("src//main//resources//fnaglossaryfixed.csv"); 
