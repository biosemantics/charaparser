...
public class TreatiseConfig extends RunConfig {
	...
	public void configure() {
		...
		bind(String.class).annotatedWith(Names.named("GuiceModuleFile")).toInstance("src//main//java//semanticMarkup//TreatiseConfig.java");

		String evaluationDataPath = "src/test/resources/evaluationData/TIP_AnsKey_CharaParser_Evaluation";
		...
		bind(String.class).annotatedWith(Names.named("CSVGlossary_filePath")).toInstance("src//main//resources//treatisehglossaryfixed.csv"); 
