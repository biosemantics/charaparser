...
public class BasicConfig extends AbstractModule {
	  ...
	  protected void configure() {	 
		...
		bind(String.class).annotatedWith(Names.named("CSVCorpus_filePath")).toInstance("src//main//resources//brown.csv");
		bind(String.class).annotatedWith(Names.named("WordNetAPI_Sourcefile")).toInstance("src//main//resources//wordNet3.1//dict//");
		//src//main//resources//wordNet2.1//dict//  src//main//resources//wordNet3.1//dict//
