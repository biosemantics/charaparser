...
public class RemoveUselessCharacterConstraintTest {
	
	private RemoveUselessCharacterConstraint transformer;
	private Element character1;
	private Element character2;
	
	public RemoveUselessCharacterConstraintTest() {
		this.transformer = new RemoveUselessCharacterConstraint();
	}
