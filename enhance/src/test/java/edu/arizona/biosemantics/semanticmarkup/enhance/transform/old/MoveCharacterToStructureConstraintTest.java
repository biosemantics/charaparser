...
public class MoveCharacterToStructureConstraintTest {
	
	private MoveCharacterToStructureConstraint transformer;
	private Element biologicalEntity1;
	private Element character0;
	
	public MoveCharacterToStructureConstraintTest() {
		this.transformer = new MoveCharacterToStructureConstraint();
	}
