...
public class StandardizeStructureName {
	
	private StandardizeStructureNameTransformer transformer;
	...
	public StandardizeStructureName() {
		this.transformer = new StandardizeStructureNameTransformer(new ICharacterKnowledgeBase() {
			@Override
