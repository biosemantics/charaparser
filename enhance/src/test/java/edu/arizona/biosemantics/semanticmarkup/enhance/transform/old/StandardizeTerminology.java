...
public class StandardizeTerminology {
	...
	private StandardizeTerminologyTransformer transformer;
	private Element biologicalEntity;
	private Element character;
	
	public StandardizeTerminology() {
		this.transformer = new StandardizeTerminologyTransformer(new ICharacterKnowledgeBase() {
			@Override
