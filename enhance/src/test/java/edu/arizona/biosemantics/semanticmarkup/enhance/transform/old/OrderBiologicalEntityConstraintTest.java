...
public class OrderBiologicalEntityConstraintTest{
	
	private OrderBiologicalEntityConstraint transformer;
	private Element biologicalEntity1;
	
	public OrderBiologicalEntityConstraintTest() {
		this.transformer = new OrderBiologicalEntityConstraint();
	}
