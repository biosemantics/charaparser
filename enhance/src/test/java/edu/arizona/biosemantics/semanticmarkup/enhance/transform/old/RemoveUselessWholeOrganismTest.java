...
public class RemoveUselessWholeOrganismTest {

	private RemoveUselessWholeOrganism transformer;
	private Element biologicalEntity1;
	private Element biologicalEntity2;
	private Element biologicalEntity3;
	
	public RemoveUselessWholeOrganismTest() {
		this.transformer = new RemoveUselessWholeOrganism();
	}
