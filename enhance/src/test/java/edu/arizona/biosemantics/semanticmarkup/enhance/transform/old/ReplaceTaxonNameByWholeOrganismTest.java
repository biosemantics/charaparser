...
public class ReplaceTaxonNameByWholeOrganismTest {
	
	private ReplaceTaxonNameByWholeOrganism transformer;
	private Element biologicalEntity1;
	private Element biologicalEntity2;
	
	public ReplaceTaxonNameByWholeOrganismTest() {
		this.transformer = new ReplaceTaxonNameByWholeOrganism();
	}
