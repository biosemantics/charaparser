package edu.arizona.biosemantics.semanticmarkup.enhance;
...
import edu.arizona.biosemantics.semanticmarkup.enhance.config.RunConfig;
...
public class CLIMain {
	...
	private void setupLogging() {
		Logger rootLogger = Logger.getRootLogger();
		rootLogger.getLoggerRepository().resetConfiguration();
		addDebugErrorLoggers(rootLogger, config.getRunRootDirectory() + File.separator + "debug.log", 
				config.getRunRootDirectory() + File.separator + "error.log");
	}
